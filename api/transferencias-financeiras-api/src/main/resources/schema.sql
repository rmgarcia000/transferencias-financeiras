...
CREATE TABLE tbl_agenda_transacao (
	...
	status_transacao CHAR(2) NOT NULL,
...
ALTER TABLE tbl_agenda_transacao ADD CONSTRAINT chk_status_transacao CHECK (status_transacao in ('AT','EP','TS', 'FT', 'AR', 'FS'));
...
ALTER TABLE tbl_controle_processamento_transacao ADD CONSTRAINT chk_status_processamento CHECK (status_processamento in ('S','F','E'));
